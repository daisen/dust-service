...
public class DataBaseImpl implements IDataBase {
    ...
    private void handleOut(List<StoreProcParam> params, CallableStatement cs) throws SQLException {
            ...
            if (DataTypeEnum.CURSOR == param.getParamDataType()) {
                try {
                    ...
                    if (null != csTmp) {
                        ...
                        rowSet.populate((ResultSet) csTmp);
                        param.setValue(DbUtils.resultSet2Map(rowSet));
                    }
