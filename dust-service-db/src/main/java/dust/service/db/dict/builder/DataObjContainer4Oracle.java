 ...
 */
public class DataObjContainer4Oracle implements IDataObjContainer {
    private Logger logger = LoggerFactory.getLogger(DataObjContainer4Oracle.class);
    private final static String LOCAL_SQL_ADAPTER = "DataObjContainer4Oracle.localSqlAdapter";
    private final static String LOCAL_SCHEMA_JSON = "DataObjContainer4Oracle.localSchemaJson";
    ...
    public ISqlAdapter getSqlAdapter() {
        ...
        try {
            if (adapter == null || adapter.getConnection() == null) {
                ...
                if (!StringUtils.equals(localSqlAdapter.get().getDbType(), "oracle")) {
